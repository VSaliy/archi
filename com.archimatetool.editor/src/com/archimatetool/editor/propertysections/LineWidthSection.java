...
public class LineWidthSection extends AbstractECorePropertySection {
    ...
    private void createLineWidthComboControl(Composite parent) {
        createLabel(parent, "Line Width:", ITabbedLayoutConstants.STANDARD_LABEL_WIDTH, SWT.CENTER);
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                for(EObject connection : getEObjects()) {
                    if(isAlive(connection)) {
                        Command cmd = new LineWidthCommand((ILineObject)connection, fComboLineWidth.getSelectionIndex());
                        if(cmd.canExecute()) {
                            result.add(cmd);
                        }
                    }
    ...
    protected void refreshLineWidthCombo() {
        ...
        fComboLineWidth.select(lineWidth);
